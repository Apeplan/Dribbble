...
class CropUtil {
    ...
    public static int getExifRotation(File imageFile) {
        ...
        try {
            ...
            switch (exif.getAttributeInt(ExifInterface.TAG_ORIENTATION, ExifInterface
    ...
    public static boolean copyExifRotation(File sourceFile, File destFile) {
        ...
        try {
            ...
            exifDest.setAttribute(ExifInterface.TAG_ORIENTATION, exifSource.getAttribute
...
//        ProgressDialog dialog = ProgressDialog.show(activity, title, message, true, false);
        SpotsDialog loadingDialog = DialogHelp.getLoadingDialog(activity, message);
        loadingDialog.show();
        new Thread(new BackgroundJob(activity, job, loadingDialog, handler)).start();
    }
    ...
    private static class BackgroundJob extends MonitoredActivity.LifeCycleAdapter implements
        ...
        public BackgroundJob(MonitoredActivity activity, Runnable job,
                             SpotsDialog dialog, Handler handler) {
